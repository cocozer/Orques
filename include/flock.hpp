...
public:
    ...
    void drawFlock3D(glm::mat4 MVMatrix, GLint uMVMatrix, GLint uMVPMatrix, glm::mat4 ProjMatrix, glm::mat4 NormalMatrix, GLint uNormalMatrix, int verticesSize) const; // brief draw boid in p6 window & param ctx the p6 context of creation
