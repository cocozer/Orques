...
public:
    ...
    void drawLightSurveyor(glm::vec3 position, glm::mat4 projMatrix, glm::mat4 MVMatrix, GLint uMVPMatrix, GLint uMVMatrix, GLint uNormalMatrix, const p6::Shader& shader, GLint uKd, GLint uKs, GLint uShininess2, GLint uLightPos2_vs, GLint uLightIntensity2);
};