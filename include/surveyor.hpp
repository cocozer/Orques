...
public:
    ...
    ~Surveyor() = default;
    void      drawSurveyor(glm::mat4 MVMatrix, GLint uMVMatrix, GLint uMVPMatrix, glm::mat4 ProjMatrix, glm::mat4 NormalMatrix, GLint uNormalMatrix, const Model& surveyor, GLuint bakedTexture, GLint uTextureName, bool left, bool right);
