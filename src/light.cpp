...
void Light::drawLightSurveyor(glm::vec3 position, glm::mat4 projMatrix, glm::mat4 MVMatrix, GLint uMVPMatrix, GLint uMVMatrix, GLint uNormalMatrix, GLint uLightPos2_vs, GLint uLightIntensity2)
{
    glm::vec4 LightPos = MVMatrix * glm::vec4(position.x, position.y, position.z, 1.0);
